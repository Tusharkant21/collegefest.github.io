      ...
      <div class="form">
       <div class="input_field">
        ...
        <div class="input_field">
            ...
            <input type="checkbox" name="r2[]" value="100m"><label style="margin-left:5px;">100m</label>
            <input type="checkbox" name="r2[]" value="200m"><label style="margin-left:5px;">200m</label>
            <input type="checkbox" name="r2[]" value="400m"><label style="margin-left:5px;">400m</label>
          
        </div> 
        <div class="input_field">
            <label style="margin-right:80px;">Performing Arts</label>
            <input type="checkbox" name="r3[]" value="Sining"><label style="margin-left:5px;">Singing</label>
